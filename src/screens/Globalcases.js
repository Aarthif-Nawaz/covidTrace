        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: "#E3E3E3" }}>
            <CardView cardElevation={30}
                ...
                <ScrollView style={{ flex: 1, }}>
                    <CardNine
                        title={"Total Cases"}
                        subTitle={String(cases.global_total_cases)}
                        image={{
                            uri:
                    ...
                    />
                     <CardNine
                        title={"New Cases"}
                        subTitle={String(cases.global_new_cases)}
                        image={{
                            uri:
                                "https://media.nationalgeographic.org/assets/photos/569/648/2adb092b-1726-4e56-a0dd-30056756ddae.jpg"
                        }}
                    ...
                    <CardNine
                        title={"Deaths"}
                        subTitle={String(cases.global_deaths)}
                        image={{
                            uri:
                                "https://media.nationalgeographic.org/assets/photos/569/648/2adb092b-1726-4e56-a0dd-30056756ddae.jpg"
                        }}
                    ...
                    <CardNine
                        title={"New Deaths"}
                        subTitle={String(cases.global_new_deaths)}
                        image={{
                            uri:
                                "https://media.nationalgeographic.org/assets/photos/569/648/2adb092b-1726-4e56-a0dd-30056756ddae.jpg"
                        }}
                    ...
                    <CardNine
                        title={"Recovered"}
                        subTitle={String(cases.global_recovered)}
                        image={{
                            uri:
                                "https://media.nationalgeographic.org/assets/photos/569/648/2adb092b-1726-4e56-a0dd-30056756ddae.jpg"
                        }}
